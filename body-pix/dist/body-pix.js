    ...
    var BodyPix = (function () {
        ...
        BodyPix.prototype.segmentPersonActivation = function (input, internalResolution, segmentationThreshold) {
            ...
            var _c = tf.tidy(function () {
                ...
                var segmentationScores = scaledSegmentScores.squeeze();
                return {
                    segmentationScores: segmentationScores,
                    segmentation: toMaskTensor(segmentationScores, segmentationThreshold),
                    heatmapScores: heatmapScores,
                    offsets: offsets,
                    displacementFwd: displacementFwd,
                    displacementBwd: displacementBwd,
                };
            }), segmentationScores = _c.segmentationScores, segmentation = _c.segmentation, heatmapScores = _c.heatmapScores, offsets = _c.offsets, displacementFwd = _c.displacementFwd, displacementBwd = _c.displacementBwd;
            resized.dispose();
            return {
                segmentationScores: segmentationScores,
                segmentation: segmentation,
